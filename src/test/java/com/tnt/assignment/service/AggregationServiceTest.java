...
class AggregationServiceTest {
    ...
    public void testExceed5Secs() {
        ...
        Mono<AggregatedResult> mono = aggregationService
                .sendThenAggregate(Optional.of(Arrays.asList("NL", "CN")), Optional.of(Arrays.asList("1", "2")), Optional.of(Arrays.asList("1", "2")));
    ...
    public void testIf503Unavailable() {
        ...
        Mono<AggregatedResult> mono = aggregationService
                .sendThenAggregate(Optional.of(Arrays.asList("DE", "BE")), Optional.of(Arrays.asList("3", "4")), Optional.of(Arrays.asList("3", "4")));
    ...
    public void testRunningConcurrent() throws InterruptedException {
        ...
        Mono<AggregatedResult> mono1 = aggregationService
                .sendThenAggregate(Optional.of(Arrays.asList("NL", "CN")), Optional.of(Arrays.asList("1", "2", "3", "4", "5")), Optional.empty());
        Mono<AggregatedResult> mono2 = aggregationService
                .sendThenAggregate(Optional.of(Arrays.asList("US", "CA", "UK")), Optional.empty(), Optional.of(Arrays.asList("1", "2", "3", "4", "5")));
        ...
        Mono<AggregatedResult> mono3 = aggregationService
                .sendThenAggregate(Optional.of(Arrays.asList("KR", "JP")), Optional.of(Arrays.asList("6", "7")), Optional.of(Arrays.asList("6", "7")));
    ...
    public void testMoreThanBatchSize() throws InterruptedException {
        ...
        Mono<AggregatedResult> mono1 = aggregationService
                .sendThenAggregate(Optional.of(Arrays.asList("NL", "CN", "US", "CA", "UK", "KR", "JP")), Optional.of(Arrays.asList("1", "2", "3", "4", "5", "6", "7")), Optional.of(Arrays.asList("1", "2", "3", "4", "5", "6", "7")));
